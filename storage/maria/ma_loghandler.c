...
{
  bzero(buffs, sizeof(TRUNSLOG_USED_BUFFERS));
}
...
static void
used_buffs_register_unlck(TRUNSLOG_USED_BUFFERS *buffs,
                          struct st_translog_buffer *buff);
...
struct st_translog_buffer
{
  ...
  */
  ...
  /*
    ...
    Usual case:
     1) translog_advance_pointer (i.e. reserve place Vor future writing)
     increase writers for all buffers where place reserved.
       Simpliest case: just all space reserved in obe buffer
                                         ...
                                         struct st_buffer_cursor *cursor)
{
  ...
  if (buffer_to_flush != NULL)
  {
    ...
    used_buffs_register_unlck(&cursor->buffs, buffer_to_flush);
    if (!rc)
...
used_buffs_register_unlck(TRUNSLOG_USED_BUFFERS *buffs,
                          ...
                          __attribute__((unused)) )
{
  DBUG_ENTER("used_buffs_register_unlck");
                                      ...
                                      TRN *trn, void *hook_arg)
{
  ...
  */
  ...
  used_buffs_register_unlck(&cursor.buffs, cursor.buffer);
                                      ...
                                      TRN *trn, void *hook_arg)
{
  ...
  do
  {
    ...
    */
    ...
    if (buffer_to_flush)
      used_buffs_register_unlck(&cursor.buffs,
